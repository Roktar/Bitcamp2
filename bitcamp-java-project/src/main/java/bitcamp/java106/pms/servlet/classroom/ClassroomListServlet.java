...
public class ClassroomListServlet extends HttpServlet {
    ...
    protected void doGet(
        ...
        try {
            ...
            out.println("<tr>");
            out.println("    <th>번호</th><th>제목</th><th>등록일</th><th>종료일</th><th>교실명</th><th>변경</th>");
            out.println("</tr>");
            
            for (Classroom classroom : list) {
                out.println("<form action='update' method='post'>");
                out.println("<tr>");
                out.printf("<td><a href='delete?no=%d'><input type='text' name='no' value='%d'></a></td>"
                        + "<td><input type='text' name='title' value='%s'></td>"
                        + "<td><input type='datetime' name='startDate' value='%s'></td>"
                        + "<td><input type='datetime' name='endDate' value='%s'></td>"
                    ...
                    classroom.getRoom());
                out.printf("<td><button>변경</button></td>");
                out.println("</tr>");
                out.println("</form>");
            }
            out.println("</table>");
